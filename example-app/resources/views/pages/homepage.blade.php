...
@section('content')
    <h1 class="mt-10 px-10 text-5xl font-normal leading-normal text-center">Mahusiae Supra</h1>
    <h2 class="mt-2 px-10 text-base font-normal text-twill-grey text-center">one small step for man, one large step for mahuset</h2>
